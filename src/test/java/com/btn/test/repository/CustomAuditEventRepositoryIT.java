package com.btn.test.repository;

import com.btn.test.GatewayApp;

import com.btn.test.config.Constants;
import com.btn.test.config.audit.AuditEventConverter;
import com.btn.test.domain.PersistentAuditEvent;
...
import static com.btn.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
